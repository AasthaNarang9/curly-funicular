    ...
    <div>
      <ul style="height: 68px; margin: 0;margin-right: 2%; display: flex; justify-content: space-between;">
        <div style="align-content: flex-start; display: flex;">
          <li class="headerlist" style="position: static; margin-bottom: 100px;"><a

            style="padding: 0;"><img src="./img/logo.png" style=" padding: 0;  width: 40%; margin-right: 70%; "></a></a></li>
          ...
          <div style=" align-content: flex-end;">
            ...
            <button type="button"
               ...
               style="background-color: transparent; border: 0; font-size: 2rem; padding: 0;margin: 0; color: black;">Home </button> </a></li>
       ...
       <img src="./img/bg3.png" > 
        <div class="centered">
       <input type="text" class="form-control" placeholder="Search Here..." aria-label="Recipient's username" aria-describedby="basic-addon2" id="myInput" onkeyup="myFunction()" style="width: 200% ; height: 40%; opacity: 0.9; font-family: Ralway; border-radius: 5px; ">
     </div>     
     </div> 

         <p>
          <div style="margin-left: 20%; z-index: -10; margin-top: 30%;">
            <button class="btn btn-dark" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" style=" height: 60px; width:   300px; font-family: Ralway; color: white; z-index: -10; margin-left: 20%; border-radius: 10px;">
              Ask A Question
            </button>
          </p>
          <div class="collapse" id="collapseExample" style=" justify-content: space-around; display: flex; overflow: hidden;" >
            <div class="card-body" >
...
<div >
    <div class="card element" style="width: 92%; margin: 4%;  padding: 10px;  box-shadow: 5px 10px 18px #888888; " value="free trial">
      <div class="card-body" >

      <h3><a  href=" #" style="  background-color: transparent; border: none; color: black;"    class="card-title "><img src="./img/user.png" width="50px;" style="margin-right: 15px; margin-left:1%;">Free Trial</a></h3>
        ...
        During the free trial, you’ll have access to benefits including online play in compatible games, a selection of NES™ games with newly added online play, and more!During the free trial, you’ll have access to benefits including online play in compatible games, a selection of NES™ games with newly added online play, and more!
    ...
    <div class="card element" style="width: 92%; margin: 4%;  padding: 10px;  box-shadow: 5px 10px 18px #888888; " value="membership">
      <div class="card-body">

      <h3><a  href=" #" style="  background-color: transparent; border: none; color: black;"   class="card-title "><img src="./img/user2.jpg" width="50px;" style="margin-right: 15px; margin-left:1%;">Membership</a></h3>
    ...
    <div class="card element" style="width: 92%; margin: 4%;  padding: 10px;  box-shadow: 5px 10px 18px #888888; " value="payment">
      <div class="card-body">

      <h3><a  href=" #" style="  background-color: transparent; border: none; color: black;"    class="card-title "><img src="./img/user3.jpg" width="50px;" style="margin-right: 15px; margin-left:1%;">Payment</a></h3>
    ...
    <div class="card element" style="width: 92%; margin: 4%;  padding: 10px;  box-shadow: 5px 10px 18px #888888; " value="vouchers">
      <div class="card-body">

      <h3><a  href=" #" style="  background-color: transparent; border: none; color: black;"   class="card-title"><img src="./img/user4.jpg" width="50px;" style="margin-right: 15px; margin-left:1%;">Vouchers</a></h3>
    ...
    <div class="card element" style="width: 92%; margin: 4%;  padding: 10px;  box-shadow: 5px 10px 18px #888888; " value='<?php echo $title;?>'>
      <div class="card-body">

      <h3><a  href=" #" style="  background-color: transparent; border: none; color: black;"  class="card-title"><img src="./img/user5.jpg" width="50px;" style="margin-right: 15px; margin-left:1%;"><?php echo $title;?></a></h3>
...
function myFunction() {
  ...
  console.log(element[1].getAttribute("value"));
  
  

  // Loop through all list items, and hide those who don't match the search query
  for (i = 0; i < element.length; i++) {
    txtValue = element[i].getAttribute("value");
 ...
 <center>
  <footer style="background-color: #23272B;" >
    <div style="display: flex; background-color: #23272B; justify-content: space-around; padding-top: 50px; padding-bottom: 50px;">
      <div>
        <ul class="footer-nav" id="ult" >
          <li><a href="#" style="color: white;">Explore</a></li>
          <li><br>
          </li>
          <br>
          <li><a href="#" style="color: white;">Fund Us</a></li>
          <li><br>
          </li>
          <br>
          <li><a href="#" style="color: white;">GoFundMe</a></li>

        </ul>
      </div>
      <div>
        <ul class="footer-nav" id="ult" style="color: white;">
          <li><a href="#" style="color: white;">About us</a></li>
          <li><br>
          </li>
          <br>
          <li><a href="#" style="color: white;">Help and Support</a></li>
          <li><br>
          </li>
          <br>
      ...
      <div>
        <ul class="footer-nav" id="ult" style="color: white;">
          ...
          <br>
          <br>
          <li><a href="#" style="color: white;">Enterprise</a></li>
